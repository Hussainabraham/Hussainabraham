        ...
        <main class="main">
                ...
                <div class="swiper-container swiper-theme nav-inner pg-inner swiper-nav-lg animation-slider pg-xxl-hide nav-xxl-show nav-hide"
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide banner banner-fixed intro-slide intro-slide1"
                            style="background-image: url(assets/images/demos/demo-rtl/sliders/slide-1.jpg); background-color: #ebeef2;">
                            <div class="container">
                                <figure class="slide-image skrollable slide-animate">
                                    <img src="assets/images/demos/demo-rtl/sliders/shoes.png" alt="Banner"
                                ...
                                <div class="banner-content y-50 text-right">
                                    ...
                                    'delay': '.2s'
                                        ...
                                        <span class="p-relative d-inline-block">Men’s</span> Custom
                                    </h5>
                                    ...
                                    'duration': '1s',
                                    'delay': '.8s'
                                }">SHOP NOW<i class="w-icon-long-arrow-left"></i></a>
                        ...
                        <div class="swiper-slide banner banner-fixed intro-slide intro-slide2"
                            style="background-image: url(assets/images/demos/demo-rtl/sliders/slide-2.jpg); background-color: #ebeef2;">
                            <div class="container">
                                <figure class="slide-image skrollable slide-animate" data-animation-options="{
                                    'name': 'fadeInUpShorter',
                                    'duration': '1s'
                                }">
                                    <img src="assets/images/demos/demo-rtl/sliders/men.png" alt="Banner"
                                ...
                                <div class="banner-content d-inline-block y-50">
                                    ...
                                    <a href="demo-rtl-shop.html"
                                        ...
                                        SHOP NOW<i class="w-icon-long-arrow-left"></i>
                                    </a>
                                </div>
                                <!-- End of .banner-content -->
                            </div>
                        ...
                        <div class="swiper-slide banner banner-fixed intro-slide intro-slide3"
                            style="background-image: url(assets/images/demos/demo-rtl/sliders/slide-3.jpg); background-color: #f0f1f2;">
                            <div class="container">
                                <figure class="slide-image skrollable slide-animate" data-animation-options="{
                                    'name': 'fadeInDownShorter',
                                    'duration': '1s'
                                }">
                                    <img src="assets/images/demos/demo-rtl/sliders/skate.png" alt="Banner"
                                        data-bottom-top="transform: translateY(10vh);"
                                ...
                                <div class="banner-content text-right y-50">
                                    ...
                                    <h3 class="banner-title p-relative font-weight-bolder ls-50 slide-animate"
                                        ...
                                        'duration': '1s',
                                        'delay': '.2s'
                                    }">skate-<span class="text-white mr-5">Roller</span>
                                    </h3>
                                    <div class="btn-group slide-animate" data-animation-options="{
                                        ...
                                        <a href="shop-list.html"
                                            class="btn btn-dark btn-outline btn-rounded btn-icon-left">SHOP
                    ...
                    <button class="swiper-button-next appear-animate"></button>
                    <button class="swiper-button-prev appear-animate"></button>
                </div>
            ...
            <div class="container">
                <div class="swiper-container appear-animate icon-box-wrapper br-sm mt-6 mb-6" data-swiper-options="{
                    ...
                    <div class="swiper-wrapper row cols-md-4 cols-sm-3 cols-1">
                        ...
                        <div class="swiper-slide icon-box icon-box-side icon-box-primary icon-box-chat mt-0">
                ...
                <div class="row category-banner-wrapper appear-animate pt-6 pb-8">
                    <div class="col-md-6 mb-4">
                        <div class="banner banner-fixed overlay-light br-xs">
                            <figure>
                                <img src="assets/images/demos/demo-rtl/banners/banner-1.jpg" alt="Category Banner"
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="banner banner-fixed overlay-light br-xs">
                            <figure>
                                <img src="assets/images/demos/demo-rtl/banners/banner-2.jpg" alt="Category Banner"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="product-details scrollable">
                                                        <h2 class="product-title mb-1"><a
                                                                href="demo-rtl-product.html">Coat Pool
                                                                Comfort Jacket</a></h2>
                                        ...
                                        <div class="swiper-wrapper row cols-lg-1 cols-md-3">
                                            <div class="swiper-slide product-widget-wrap">
                                                <div class="product product-widget bb-no">
                                                    ...
                                                    <div class="product-details">
                                                        <h4 class="product-name">
                                                            <a href="demo-rtl-product.html">Kitchen Cooker</a>
                                                        </h4>
                                                        <div class="ratings-container">
                                                            <div class="ratings-full">
                                                ...
                                                <div class="product product-widget bb-no">
                                                    ...
                                                    <div class="product-details">
                                                        <h4 class="product-name">
                                                            <a href="demo-rtl-product.html">Professional Pixel
                                                                Camera</a>
                                                        </h4>
                                                        <div class="ratings-container">
                                                            <div class="ratings-full">
                                                ...
                                                <div class="product product-widget">
                                                    ...
                                                    <div class="product-details">
                                                        <h4 class="product-name">
                                                            <a href="demo-rtl-product.html">Sport Women’s Wear</a>
                                                        </h4>
                                                        <div class="ratings-container">
                                                            <div class="ratings-full">
                                                                <span class="ratings" style="width: 60%;"></span>
                                            ...
                                            <div class="swiper-slide product-widget-wrap">
                                                <div class="product product-widget bb-no">
                                                    ...
                                                    <div class="product-details">
                                                        <h4 class="product-name">
                                                            <a href="demo-rtl-product.html">Latest Speaker</a>
                                                        </h4>
                                                        <div class="ratings-container">
                                                            <div class="ratings-full">
                                                                <span class="ratings" style="width: 60%;"></span>
                                                ...
                                                <div class="product product-widget bb-no">
                                                    ...
                                                    <div class="product-details">
                                                        <h4 class="product-name">
                                                            <a href="demo-rtl-product.html">Men's Black Wrist
                                                                Watch</a>
                                                        </h4>
                                                        <div class="ratings-container">
                                                            <div class="ratings-full">
                                                ...
                                                <div class="product product-widget">
                                                    ...
                                                    <div class="product-details">
                                                        <h4 class="product-name">
                                                            <a href="demo-rtl-product.html">Wash Machine</a>
                                                        </h4>
                                                        <div class="ratings-container">
                                                            <div class="ratings-full">
                                                                <span class="ratings" style="width: 100%;"></span>
                                            ...
                                            <div class="swiper-slide product-widget-wrap">
                                                <div class="product product-widget bb-no">
                                                    ...
                                                    <div class="product-details">
                                                        <h4 class="product-name">
                                                            <a href="demo-rtl-product.html">Security Guard</a>
                                                        </h4>
                                                        <div class="ratings-container">
                                                            <div class="ratings-full">
                                                                <span class="ratings" style="width: 100%;"></span>
                                                ...
                                                <div class="product product-widget bb-no">
                                                    ...
                                                    <div class="product-details">
                                                        <h4 class="product-name">
                                                            <a href="demo-rtl-product.html">Apple Super Notecom</a>
                                                        </h4>
                                                        <div class="ratings-container">
                                                            <div class="ratings-full">
                                                                <span class="ratings" style="width: 100%;"></span>
                                                ...
                                                <div class="product product-widget">
                                                    ...
                                                    <div class="product-details">
                                                        <h4 class="product-name">
                                                            <a href="demo-rtl-product.html">HD Television</a>
                                                        </h4>
                                                        <div class="ratings-container">
                                                            <div class="ratings-full">
                                                                <span class="ratings" style="width: 60%;"></span>
            ...
            <section class="category-section top-category bg-grey pt-10 pb-10 appear-animate">
                <div class="container pb-2">
                    ...
                    <div class="swiper">
                        <div class="swiper-container swiper-theme shadow-swiper pg-show" data-swiper-options="{
                            'spaceBetween': 20,
                            'slidesPerView': 2,
                            'breakpoints': {
                                '576': {
                            ...
                            <div class="swiper-wrapper row cols-lg-6 cols-md-5 cols-sm-3 cols-2">
                                <div
                                    ...
                                    <a href="demo-rtl-shop.html" class="category-media">
                                        <img src="assets/images/demos/demo-rtl/categories/2-1.jpg" alt="Category"
                                ...
                                <div
                                    class="swiper-slide category category-classic category-absolute overlay-zoom br-xs">
                                    <a href="demo-rtl-shop.html" class="category-media">
                                        <img src="assets/images/demos/demo-rtl/categories/2-2.jpg" alt="Category"
                                            width="130" height="130">
                                    </a>
                                    <div class="category-content">
                                ...
                                <div
                                    class="swiper-slide category category-classic category-absolute overlay-zoom br-xs">
                                    <a href="demo-rtl-shop.html" class="category-media">
                                        <img src="assets/images/demos/demo-rtl/categories/2-3.jpg" alt="Category"
                                            width="130" height="130">
                                    </a>
                                    <div class="category-content">
                                ...
                                <div
                                    class="swiper-slide category category-classic category-absolute overlay-zoom br-xs">
                                    <a href="demo-rtl-shop.html" class="category-media">
                                        <img src="assets/images/demos/demo-rtl/categories/2-4.jpg" alt="Category"
                                            width="130" height="130">
                                    </a>
                                    <div class="category-content">
                                ...
                                <div
                                    class="swiper-slide category category-classic category-absolute overlay-zoom br-xs">
                                    <a href="demo-rtl-shop.html" class="category-media">
                                        <img src="assets/images/demos/demo-rtl/categories/2-5.jpg" alt="Category"
                                            width="130" height="130">
                                    </a>
                                    <div class="category-content">
                                ...
                                <div
                                    class="swiper-slide category category-classic category-absolute overlay-zoom br-xs">
                                    <a href="demo-rtl-shop.html" class="category-media">
                                        <img src="assets/images/demos/demo-rtl/categories/2-6.jpg" alt="Category"
                                            width="130" height="130">
                                    </a>
                                    <div class="category-content">
            ...
            <div class="container">
                        ...
                        <div class="row cols-xl-5 cols-md-4 cols-sm-3 cols-2">
                            <div class="product-wrap">
                                <div class="product text-center">
                                    ...
                                    <div class="product-details">
                                        <h4 class="product-name"><a href="demo-rtl-product.html">Classic Hat</a></h4>
                                        <div class="ratings-container">
                                            <div class="ratings-full">
                                                <span class="ratings" style="width: 60%;"></span>
                                                <span class="tooltiptext tooltip-top"></span>
                                            </div>
                                            <a href="demo-rtl-product.html" class="rating-reviews">(1 Reviews)</a>
                                        </div>
                                        <div class="product-price">
                            ...
                            <div class="product-wrap">
                                <div class="product text-center">
                                    ...
                                    <div class="product-details">
                                        <h4 class="product-name"><a href="demo-rtl-product.html">Women’s White
                                                Handbag</a></h4>
                                        <div class="ratings-container">
                                            <div class="ratings-full">
                                                <span class="ratings" style="width: 80%;"></span>
                                            ...
                                            <a href="demo-rtl-product.html" class="rating-reviews">(3 reviews)</a>
                                        </div>
                                        <div class="product-price">
                            ...
                            <div class="product-wrap">
                                <div class="product text-center">
                                    ...
                                    <div class="product-details">
                                        <h4 class="product-name"><a href="demo-rtl-product.html">Multi Funtional
                                                Apple
                                                iPhone</a></h4>
                                        <div class="ratings-container">
                                            <div class="ratings-full">
                                            ...
                                            <a href="demo-rtl-product.html" class="rating-reviews">(5 reviews)</a>
                                        </div>
                                        <div class="product-price">
                            ...
                            <div class="product-wrap">
                                <div class="product text-center">
                                    ...
                                    <div class="product-details">
                                        <h4 class="product-name"><a href="demo-rtl-product.html">Fashion Blue
                                                Towel</a>
                                        </h4>
                                        <div class="ratings-container">
                                            <div class="ratings-full">
                                            ...
                                            <a href="demo-rtl-product.html" class="rating-reviews">(8 reviews)</a>
                                        </div>
                                        <div class="product-price">
                            ...
                            <div class="product-wrap">
                                <div class="product text-center">
                                    ...
                                    <div class="product-details">
                                        <h4 class="product-name"><a href="demo-rtl-product.html">Apple Super
                                                Notecom</a>
                                        </h4>
                                        <div class="ratings-container">
                                            <div class="ratings-full">
                                            ...
                                            <a href="demo-rtl-product.html" class="rating-reviews">(4 reviews)</a>
                                        </div>
                                        <div class="product-price">
                                            <ins class="new-price">$243.30</ins>
                                            <del class="old-price">$253.50</del>
                            ...
                            <div class="product-wrap">
                                <div class="product text-center">
                                    ...
                                    <div class="product-details">
                                        <h4 class="product-name"><a href="demo-rtl-product.html">Women’s
                                                Comforter</a>
                                        </h4>
                                        <div class="ratings-container">
                                            <div class="ratings-full">
                                            ...
                                            <a href="demo-rtl-product.html" class="rating-reviews">(10 reviews)</a>
                                        </div>
                                        <div class="product-price">
                            ...
                            <div class="product-wrap">
                                <div class="product text-center">
                                    ...
                                    <div class="product-details">
                                        <h4 class="product-name"><a href="demo-rtl-product.html">Multi-colorful
                                                Music</a>
                                        </h4>
                                        <div class="ratings-container">
                                            <div class="ratings-full">
                            ...
                            <div class="product-wrap">
                                <div class="product text-center">
                                    ...
                                    <div class="product-details">
                                        <h4 class="product-name"><a href="demo-rtl-product.html">Comfortable
                                                Backpack</a>
                                        </h4>
                                        <div class="ratings-container">
                                            <div class="ratings-full">
                                            ...
                                            <a href="demo-rtl-product.html" class="rating-reviews">(6 reviews)</a>
                                        </div>
                                        <div class="product-price">
                            ...
                            <div class="product-wrap">
                                <div class="product text-center">
                                    ...
                                    <div class="product-details">
                                        <h4 class="product-name"><a href="demo-rtl-product.html">Data Transformer
                                                Tool
                                            </a></h4>
                                        <div class="ratings-container">
                                            <div class="ratings-full">
                            ...
                            <div class="product-wrap">
                                <div class="product text-center">
                                    ...
                                    <div class="product-details">
                                        <h4 class="product-name"><a href="demo-rtl-product.html">Women’s hairdye</a>
                                        </h4>
                                        <div class="ratings-container">
                                            <div class="ratings-full">
                                                <span class="ratings" style="width: 60%;"></span>
                ...
                <div class="row category-cosmetic-lifestyle appear-animate mb-5">
                    <div class="col-md-6 mb-4">
                        <div class="banner banner-fixed overlay-light category-banner-1 br-xs">
                            <figure>
                                <img src="assets/images/demos/demo-rtl/banners/banner-4.jpg" alt="Category Banner"
                            ...
                            <div class="banner-content y-50 pt-1">
                                ...
                                <a href="demo-rtl-shop.html"
                                    class="btn btn-white btn-link btn-underline btn-icon-left">Shop Now<i
                                        class="w-icon-long-arrow-left"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 mb-4">
                        <div class="banner banner-fixed overlay-light category-banner-2 br-xs">
                            <figure>
                                <img src="assets/images/demos/demo-rtl/banners/banner-3.jpg" alt="Category Banner"
                            ...
                            <div class="banner-content y-50 pt-1">
                                ...
                                <a href="demo-rtl-shop.html"
                                    class="btn btn-dark btn-link btn-underline btn-icon-left">Shop Now<i
                                        class="w-icon-long-arrow-left"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="product-wrapper-1 appear-animate mb-5">
                    <div class="title-link-wrapper pb-1 mb-4">
                        ...
                        <a href="shop-boxed-banner.html"
                            class="btn btn-link btn-icon-left font-size-normal font-weight-bold ls-25 mb-0">More
                            Products<i class="w-icon-long-arrow-left"></i></a>
                    </div>
                    <div class="row">
                        <div class="col-lg-3 col-sm-4 mb-4">
                            <div class="banner overlay-light h-100 br-sm" style="background-image: url(assets/images/demos/demo-rtl/banners/banner-5.jpg); 
                                ...
                                <div class="swiper-wrapper row cols-xl-4 cols-lg-3 cols-2">
                                    <div class="swiper-slide product-col">
                                        <div class="product-wrap product text-center">
                                            <figure class="product-media">
                                                <a href="#">
                                                    <img src="assets/images/demos/demo1/products/4-1.jpg"
                                            ...
                                            <div class="product-details">
                                                <h4 class="product-name"><a href="demo-rtl-product.html">Men’s
                                                        Clothing</a>
                                                </h4>
                                                <div class="ratings-container">
                                                    <div class="ratings-full">
                                                    ...
                                                    <a href="demo-rtl-product.html" class="rating-reviews">(3
                                                        reviews)</a>
                                                </div>
                                                <div class="product-price">
                                        ...
                                        <div class="product-wrap product text-center">
                                            ...
                                            <div class="product-details">
                                                <h4 class="product-name"><a href="demo-rtl-product.html">Best Travel
                                                        Bag</a>
                                                </h4>
                                                <div class="ratings-container">
                                                    <div class="ratings-full">
                                    ...
                                    <div class="swiper-slide product-col">
                                        ...
                                        <div class="product-wrap product text-center">
                                            <figure class="product-media">
                                                <a href="#">
                                                    <img src="assets/images/demos/demo1/products/4-6.jpg"
                                                        alt="Product" width="216" height="243" />
                                                </a>
                                                <div class="product-action-vertical">
                                                    <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                            ...
                                            <div class="product-details">
                                                <h4 class="product-name"><a href="demo-rtl-product.html">Gray Leather
                                                        Shoes</a></h4>
                                                <div class="ratings-container">
                                                    <div class="ratings-full">
                                                        <span class="ratings" style="width: 60%;"></span>
                                                ...
                                                <div class="product-price">
                                                    <ins class="new-price">$26.88</ins>
                                                    <del class="old-price">$27.89</del>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide product-col">
                                        <div class="product-wrap product text-center">
                                            <figure class="product-media">
                                                <a href="#">
                                                    <img src="assets/images/demos/demo1/products/4-3.jpg"
                                                        alt="Product" width="216" height="243" />
                                                </a>
                                                <div class="product-action-vertical">
                                                    <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                            ...
                                            <div class="product-details">
                                                <h4 class="product-name"><a href="demo-rtl-product.html">Black Winter
                                                        Skating</a></h4>
                                                <div class="ratings-container">
                                                    <div class="ratings-full">
                                                        <span class="ratings" style="width: 60%;"></span>
                                                ...
                                                <div class="product-price">
                                                    <ins class="new-price">$40.86</ins>
                                                    <del class="old-price">$45.89</del>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="product-wrap product text-center">
                                            <figure class="product-media">
                                                <a href="#">
                                                    <img src="assets/images/demos/demo1/products/4-7.jpg"
                                                        alt="Product" width="216" height="243" />
                                                </a>
                                                <div class="product-action-vertical">
                                                    <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                            ...
                                            <div class="product-details">
                                                <h4 class="product-name"><a href="demo-rtl-product.html">Men's Black
                                                        Wrist
                                                        Watch</a></h4>
                                                <div class="ratings-container">
                                                    <div class="ratings-full">
                                    ...
                                    <div class="swiper-slide product-col">
                                        <div class="product-wrap product text-center">
                                            ...
                                            <div class="product-details">
                                                <h4 class="product-name"><a href="demo-rtl-product.html">Sport
                                                        Women's
                                                        Wear</a></h4>
                                                <div class="ratings-container">
                                                    <div class="ratings-full">
                                        ...
                                        <div class="product-wrap product text-center">
                                            <figure class="product-media">
                                                <a href="#">
                                                    <img src="assets/images/demos/demo1/products/4-8.jpg"
                                                        alt="Product" width="216" height="243" />
                                                </a>
                                                <div class="product-action-vertical">
                                                    <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                ...
                <div class="product-wrapper-1 appear-animate mb-8">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-sm-4 mb-4">
                            <div class="banner overlay-light h-100 br-sm" style="background-image: url(assets/images/demos/demo-rtl/banners/banner-6.jpg); 
                                ...
                                <div class="swiper-wrapper row cols-xl-4 cols-lg-3 cols-2">
                                    <div class="swiper-slide product-col">
                                        <div class="product-wrap product text-center">
                                            ...
                                            <div class="product-details">
                                                <h4 class="product-name"><a href="demo-rtl-product.html">Professional
                                                        Pixel
                                                        Camera</a></h4>
                                                <div class="ratings-container">
                                                    <div class="ratings-full">
                                                    ...
                                                    <a href="demo-rtl-product.html" class="rating-reviews">(5
                                                        reviews)</a>
                                                </div>
                                                <div class="product-price">
                                                    <ins class="new-price">$215.68</ins>
                                        ...
                                        <div class="product-wrap product text-center">
                                            <figure class="product-media">
                                                <a href="demo-rtl-product.html">
                                                    <img src="assets/images/demos/demo1/products/5-5.jpg"
                                                        alt="Product" width="216" height="243" />
                                                </a>
                                                <div class="product-action-vertical">
                                                    <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                            ...
                                            <div class="product-details">
                                                <h4 class="product-name"><a href="demo-rtl-product.html">Latest
                                                        Speaker</a>
                                                </h4>
                                                <div class="ratings-container">
                                                    <div class="ratings-full">
                                    ...
                                    <div class="swiper-slide product-col">
                                        <div class="product-wrap product text-center">
                                            ...
                                            <div class="product-details">
                                                <h4 class="product-name"><a href="demo-rtl-product.html">Wash
                                                        Machine</a>
                                                </h4>
                                                <div class="ratings-container">
                                                    <div class="ratings-full">
                                                    ...
                                                    <a href="demo-rtl-product.html" class="rating-reviews">(9
                                                        reviews)</a>
                                                </div>
                                                <div class="product-price">
                                                    <ins class="new-price">$215.68</ins>
                                        ...
                                        <div class="product-wrap product text-center">
                                            <figure class="product-media">
                                                <a href="demo-rtl-product.html">
                                                    <img src="assets/images/demos/demo1/products/5-6.jpg"
                                                        alt="Product" width="216" height="243" />
                                                </a>
                                                <div class="product-action-vertical">
                                                    <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                            ...
                                            <div class="product-details">
                                                <h4 class="product-name"><a href="demo-rtl-product.html">Security
                                                        Guard</a>
                                                </h4>
                                                <div class="ratings-container">
                                                    <div class="ratings-full">
                                    ...
                                    <div class="swiper-slide product-col">
                                        <div class="product-wrap product text-center">
                                            <figure class="product-media">
                                                <a href="demo-rtl-product.html">
                                                    <img src="assets/images/demos/demo1/products/5-3.jpg"
                                                        alt="Product" width="216" height="243" />
                                                </a>
                                                <div class="product-action-vertical">
                                                    <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                            ...
                                            <div class="product-details">
                                                <h4 class="product-name"><a href="demo-rtl-product.html">HD
                                                        Television</a>
                                                </h4>
                                                <div class="ratings-container">
                                                    <div class="ratings-full">
                                        ...
                                        <div class="product-wrap product text-center">
                                            <figure class="product-media">
                                                <a href="demo-rtl-product.html">
                                                    <img src="assets/images/demos/demo1/products/5-7.jpg"
                                                        alt="Product" width="216" height="243" />
                                                </a>
                                                <div class="product-action-vertical">
                                                    <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                            ...
                                            <div class="product-details">
                                                <h4 class="product-name"><a href="demo-rtl-product.html">USB
                                                        Receipt</a>
                                                </h4>
                                                <div class="ratings-container">
                                                    <div class="ratings-full">
                                                ...
                                                <div class="product-price">
                                                    <ins class="new-price">$26.89</ins>
                                                    <del class="old-price">$29.79</del>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide product-col">
                                        <div class="product-wrap product text-center">
                                            <figure class="product-media">
                                                <a href="demo-rtl-product.html">
                                                    <img src="assets/images/demos/demo1/products/5-4.jpg"
                                                        alt="Product" width="216" height="243" />
                                                </a>
                                                <div class="product-action-vertical">
                                                    <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                            ...
                                            <div class="product-details">
                                                <h4 class="product-name"><a href="demo-rtl-product.html">Data
                                                        Transformer
                                                        Tool</a></h4>
                                                <div class="ratings-container">
                                                    <div class="ratings-full">
                                                    ...
                                                    <a href="demo-rtl-product.html" class="rating-reviews">(6
                                                        reviews)</a>
                                                </div>
                                                <div class="product-price">
                                        ...
                                        <div class="product-wrap product text-center">
                                            <figure class="product-media">
                                                <a href="demo-rtl-product.html">
                                                    <img src="assets/images/demos/demo1/products/5-8.jpg"
                                                        alt="Product" width="216" height="243" />
                                                </a>
                                                <div class="product-action-vertical">
                                                    <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                            ...
                                            <div class="product-details">
                                                <h4 class="product-name"><a href="demo-rtl-product.html">Multi
                                                        Functional
                                                        Apple iPhone</a></h4>
                                                <div class="ratings-container">
                                                    <div class="ratings-full">
                ...
                <div class="banner banner-fashion appear-animate br-sm mb-9" style="background-image: url(assets/images/demos/demo-rtl/banners/banner-7.jpg);
                    ...
                    <div class="banner-content align-items-center">
                        <div class="content-left d-flex align-items-center mb-3">
                            ...
                            <hr class="banner-divider bg-white mt-0 mb-0 ml-8 mr-8">
                        </div>
                        <div class="content-right d-flex align-items-center flex-1 flex-wrap">
                            <div class="banner-info mb-0 mr-auto pl-4 mb-3">
                                ...
                                <p class="text-white mb-0">Use code
                                    <span
                                        ...
                                        12345</span> to get best offer.</p>
                            </div>
                            <a href="demo-rtl-shop.html"
                                class="btn btn-white btn-outline btn-rounded btn-icon-left mb-3">Shop Now<i
                                    class="w-icon-long-arrow-left"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="product-wrapper-1 product-wrapper-home appear-animate mb-7">
                    <div class="title-link-wrapper pb-1 mb-4">
                        <h2 class="title ls-normal mb-0 ml-2">Home Garden & Kitchen</h2>
                        <a href="shop-boxed-banner.html"
                            class="btn btn-link btn-icon-left font-size-normal font-weight-bold ls-25 mb-0">More
                            Products<i class="w-icon-long-arrow-left"></i></a>
                    </div>
                    <div class="row">
                        <div class="col-lg-3 col-sm-4 mb-4">
                            <div class="banner overlay-light h-100 br-sm" style="background-image: url(assets/images/demos/demo-rtl/banners/banner-8.jpg); 
                                ...
                                <div class="swiper-wrapper row cols-xl-4 cols-lg-3 cols-2">
                                    <div class="swiper-slide product-col">
                                        <div class="product-wrap product text-center">
                                            <figure class="product-media">
                                                <a href="demo-rtl-product.html">
                                                    <img src="assets/images/demos/demo1/products/6-1.jpg"
                                                        alt="Product" width="216" height="243" />
                                                </a>
                                                <div class="product-action-vertical">
                                                    <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                            ...
                                            <div class="product-details">
                                                <h4 class="product-name"><a href="demo-rtl-product.html">Home
                                                        Sofa</a>
                                                </h4>
                                                <div class="ratings-container">
                                                    <div class="ratings-full">
                                        ...
                                        <div class="product-wrap product text-center">
                                            <figure class="product-media">
                                                <a href="demo-rtl-product.html">
                                                    <img src="assets/images/demos/demo1/products/6-5.jpg"
                                                        alt="Product" width="216" height="243" />
                                                </a>
                                                <div class="product-action-vertical">
                                                    <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                            ...
                                            <div class="product-details">
                                                <h4 class="product-name"><a href="demo-rtl-product.html">Electric
                                                        Rice-Cooker</a></h4>
                                                <div class="ratings-container">
                                                    <div class="ratings-full">
                                                        <span class="ratings" style="width: 60%;"></span>
                                    ...
                                    <div class="swiper-slide product-col">
                                        <div class="product-wrap product text-center">
                                            ...
                                            <div class="product-details">
                                                <h4 class="product-name"><a href="demo-rtl-product.html">Kitchen
                                                        Table</a>
                                                </h4>
                                                <div class="ratings-container">
                                                    <div class="ratings-full">
                                                ...
                                                <div class="product-price">
                                                    <ins class="new-price">$75.50</ins>
                                                    <del class="old-price">$95.68</del>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="product-wrap product text-center">
                                            <figure class="product-media">
                                                <a href="demo-rtl-product.html">
                                                    <img src="assets/images/demos/demo1/products/6-6.jpg"
                                                        alt="Product" width="216" height="243" />
                                                </a>
                                                <div class="product-action-vertical">
                                                    <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                    ...
                                    <div class="swiper-slide product-col">
                                        <div class="product-wrap product text-center">
                                            ...
                                            <div class="product-details">
                                                <h4 class="product-name"><a href="demo-rtl-product.html">Table
                                                        Lamp</a>
                                                </h4>
                                                <div class="ratings-container">
                                                    <div class="ratings-full">
                                        ...
                                        <div class="product-wrap product text-center">
                                            <figure class="product-media">
                                                <a href="demo-rtl-product.html">
                                                    <img src="assets/images/demos/demo1/products/6-7.jpg"
                                                        alt="Product" width="216" height="243" />
                                                </a>
                                                <div class="product-action-vertical">
                                                    <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                            ...
                                            <div class="product-details">
                                                ...
                                                <div class="product-price">
                                                    <ins class="new-price">$137.35</ins>
                                                    <del class="old-price">$155.65</del>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide product-col">
                                        <div class="product-wrap product text-center">
                                            <figure class="product-media">
                                                <a href="demo-rtl-product.html">
                                                    <img src="assets/images/demos/demo1/products/6-4.jpg"
                                                        alt="Product" width="216" height="243" />
                                                </a>
                                                <div class="product-action-vertical">
                                                    <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                        ...
                                        <div class="product-wrap product text-center">
                                            ...
                                            <div class="product-details">
                                                <h4 class="product-name"><a href="demo-rtl-product.html">Automatic
                                                        Crusher</a></h4>
                                                <div class="ratings-container">
                                                    <div class="ratings-full">
                                                        <span class="ratings" style="width: 100%;"></span>
                ...
                <div class="post-wrapper appear-animate mb-4">
                    <div class="title-link-wrapper pb-1 mb-4">
                        <h2 class="title ls-normal mb-0 ml-lg-2">From Our Blog</h2>
                        <a href="blog-listing.html"
                            class="btn btn-link font-weight-bold font-size-normal ls-25 mb-0">View All Articles</a>
                    </div>
                    <div class="swiper">
                        <div class="swiper-container swiper-theme" data-swiper-options="{
                            'slidesPerView': 1,
                            ...
                            <div class="swiper-wrapper row cols-lg-4 cols-md-3 cols-sm-2 cols-1">
                                <div class="swiper-slide post text-center overlay-zoom">
                                    <figure class="post-media br-sm">
                                        <a href="post-single.html">
                                            <img src="assets/images/demos/demo-rtl/blogs/1.jpg" alt="Post" width="280"
                                                height="180" style="background-color: #4b6e91;" />
                                        </a>
                                    </figure>
                                    <div class="post-details">
                                        <div class="post-meta">
                                            <a href="#" class="post-author">John Doe</a>
                                            by&nbsp;-&nbsp;<a href="#" class="post-date ml-0">03.05.2021</a>
                                        </div>
                                        ...
                                        <a href="post-single.html" class="btn btn-link btn-dark btn-underline">Read
                                            More<i class="w-icon-long-arrow-left"></i></a>
                                    </div>
                                </div>
                                <div class="swiper-slide post text-center overlay-zoom">
                                    <figure class="post-media br-sm">
                                        <a href="post-single.html">
                                            <img src="assets/images/demos/demo-rtl/blogs/2.jpg" alt="Post" width="280"
                                ...
                                <div class="swiper-slide post text-center overlay-zoom">
                                    <figure class="post-media br-sm">
                                        <a href="post-single.html">
                                            <img src="assets/images/demos/demo-rtl/blogs/3.jpg" alt="Post" width="280"
                                ...
                                <div class="swiper-slide post text-center overlay-zoom">
                                    <figure class="post-media br-sm">
                                        <a href="post-single.html">
                                            <img src="assets/images/demos/demo-rtl/blogs/4.jpg" alt="Post" width="280"
                    ...
                    <div class="swiper-wrapper row cols-xl-8 cols-lg-6 cols-md-4 cols-2">
                        <div class="swiper-slide product-wrap mb-0">
                            <div class="product text-center product-absolute">
                                <figure class="product-media">
                                    <a href="https://www.portotheme.com/html/wolmart/product-defademo-rtl-product.html">
                                        <img src="assets/images/demos/demo1/products/7-1.jpg" alt="Category image"
                                            width="130" height="146" style="background-color: #fff" />
                                    </a>
                                </figure>
                                <h4 class="product-name">
                                    <a href="demo-rtl-product.html">Women's Fashion Handbag</a>
                                </h4>
                            </div>
                        </div>
                        <!-- End of Product Wrap -->
                        <div class="swiper-slide product-wrap mb-0">
                            <div class="product text-center product-absolute">
                                ...
                                <h4 class="product-name">
                                    <a href="demo-rtl-product.html">Electric Frying Pan</a>
                                </h4>
                            </div>
                        </div>
                        <!-- End of Product Wrap -->
                        <div class="swiper-slide product-wrap mb-0">
                            <div class="product text-center product-absolute">
                                ...
                                <h4 class="product-name">
                                    <a href="demo-rtl-product.html">Black Winter Skating</a>
                                </h4>
                            </div>
                        </div>
                        <!-- End of Product Wrap -->
                        ...
                        <div class="swiper-slide product-wrap mb-0">
                            <div class="product text-center product-absolute">
                                ...
                                <h4 class="product-name">
                                    <a href="demo-rtl-product.html">Home Sofa</a>
                                </h4>
                            </div>
                        </div>
                        <!-- End of Product Wrap -->
                        <div class="swiper-slide product-wrap mb-0">
                            <div class="product text-center product-absolute">
                                ...
                                <h4 class="product-name">
                                    <a href="demo-rtl-product.html">USB Receipt</a>
                                </h4>
                            </div>
                        </div>
                        <!-- End of Product Wrap -->
                        <div class="swiper-slide product-wrap mb-0">
                            <div class="product text-center product-absolute">
                                ...
                                <h4 class="product-name">
                                    <a href="demo-rtl-product.html">Electric Rice-Cooker</a>
                                </h4>
                            </div>
                        </div>
                        <!-- End of Product Wrap -->
                        <div class="swiper-slide product-wrap mb-0">
                            <div class="product text-center product-absolute">
                                ...
                                <h4 class="product-name">
                                    <a href="demo-rtl-product.html">Table Lamp</a>
                                </h4>
                            </div>
                        </div>
                        <!-- End of Product Wrap -->
